...
public class TennisSetTest {
    ...
    public void firstPlayerDomination(){
        TennisSet set = TennisSet.between("Ali", "Fz");
        ...
        assertFalse(set.incrementFirstPlayer()); // deja gagné

        Optional<Player> winner = set.getWinner();
        assertTrue(winner.isPresent());
        assertEquals("Ali", ((Player) set.getWinner().get()).getName());
    }
    ...
    public void secondPlayerDomination(){
        ...
        Optional<Player> winner = set.getWinner();
        assertTrue(winner.isPresent());
        assertEquals("Fz", ((Player) set.getWinner().get()).getName());
    }
